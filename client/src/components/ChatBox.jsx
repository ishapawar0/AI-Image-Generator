...
const Chatbox = () => {
  const { chats, selectedChat, user, axios, token, setUser, fetchUsersChats } =
    useAppContext();
        ...
        {loading && (
          <div className="my-4 flex items-center justify-start gap-2">
            ...
            {mode === "image" ? (
              ...
              <div className="loader flex items-center gap-1.5 justify-center p-4 bg-primary/20 dark:bg-[#57317C]/30 border border-[#80609F]/30 rounded-md">
